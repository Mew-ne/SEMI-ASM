...
class CategoryController extends AbstractController
{
    ...
    public function detailsCategory(ManagerRegistry $doctrine, CartManager $cartManager, ProductRepository $productRepository): Response
    {
        ...
        return $this->render('category/details.html.twig', [
            'products' => $products, 'categories'=>$categories, 'cart' => $cart, 'latestProducts'=>$latestProducts
        ]);
    }
